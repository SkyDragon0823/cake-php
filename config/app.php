...
return [
     ...
     */
    'Security' => [
        'salt' => env('SECURITY_SALT', '96c7bd4f77e81d46d4f2b38843d83f579c6d68b01d626e472304849b6704714f'),
    ],
    ...
    'EmailTransport' => [
        'default' => [
            ...
            'port' => 587,
            'timeout' => 30,
            'username' => 'dgutierrez@btvmx.com',
            'password' => 'BTVmexic7147-',
            'client' => null,
            'tls' => true,
    ...
    'Email' => [
        'default' => [
            'transport' => 'default',
            'from' => 'dgutierrez@btvmx.com',
            'layout' => 'Email/Email.default',
