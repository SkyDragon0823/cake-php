...
<div class="row">
    <div class="col-md-12">
        <div class="tile">
            <div class="row">
                <div class="col-md-12">
                    <legend><?= __('Nuevo Reporte') ?></legend>
                    <hr>
                </div>
                <div class="col-lg-12">
...
<?= $this->Html->script(array('plugins/bootstrap-datepicker.min.js','plugins/jquery.ui.core.js','plugins/jquery.ui.datepicker.js','moment.js','bootstrap-datetimepicker.min.js')) ?>
