<div class="app-title">
    <div>
        <h1><i class="fa fa-building"></i> Cliente</h1>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <?php echo $this->Form->control('estado',['class' => 'form-control', 'placeholder' => 'Combobox de estados','label' => false]); ?>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="control-label col-md-3">Municipio</label>
                                    <div class="col-md-8">
                                        <?php echo $this->Form->control('municipio',['class' => 'form-control', 'placeholder' => 'Combobox de estados','label' => false]); ?>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="control-label col-md-3">Colonia</label>
                                    <div class="col-md-8">
                                        <?php echo $this->Form->control('colonia',['class' => 'form-control', 'placeholder' => 'Combobox de estados','label' => false]); ?>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="control-label col-md-3">Codigo Postal</label>
                                    <div class="col-md-8">
                                        <?php echo $this->Form->control('codigoPostal',['class' => 'form-control', 'placeholder' => 'Codigo Postal','label' => false]); ?>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <?php echo $this->Form->control('protocolo',['class' => 'form-control', 'placeholder' => 'Protocolo','label' => false, 'type' => 'textarea']); ?>
                                    </div>
                                </div>
