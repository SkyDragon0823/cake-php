 ...
 * @method \App\Model\Entity\Certificacione|bool saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
...
class CertificacionesTable extends Table
{
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ->scalar('certificacion')
            ->maxLength('certificacion', 250)
            ->allowEmptyString('certificacion');
        ...
        $validator
            ...
            ->allowEmptyDateTime('fechaCertificacion');

        $validator
            ->dateTime('fechaVencimiento')
            ->allowEmptyDateTime('fechaVencimiento');
