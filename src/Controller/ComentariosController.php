...
class ComentariosController extends AppController
{
    ...
    public function index()
    {
        ...
        $comentarios = $this->paginate($this->Comentarios->find()->where(['idTicket' => $keyword]));
    ...
    public function add()
    {
        ...
        if ($this->request->is('post')) {
            $comentario = $this->Comentarios->patchEntity($comentario, $this->request->getData(),['associated' => []]);
            if ($this->Comentarios->save($comentario)) {
                // $this->Flash->success(__('Comentario guardado'));
